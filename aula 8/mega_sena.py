...
if quantos_numeros_deaposta == 6:
    ...
    m1 = int(input('Escolha de 1 á 60: '))
    m2 = int(input('Escolha de 1 á 60: '))
    m3 = int(input('Escolha de 1 á 60: '))
    m4 = int(input('Escolha de 1 á 60: '))
    m5 = int(input('Escolha de 1 á 60: '))
    m6 = int(input('Escolha de 1 á 60: '))
